 ...
 *
 * 에셋: /img/chain@2x.webp 하나만 쓴다. 아래 도표의 요약 장식이라 정지컷이다.
 * 원래 편집본에서 잘라낸 워프였는데 250°(보라)라 사이트 브랜드색 215° 와 35° 벌어져
 * 있었다. 색상 회전으로는 줄기의 보라·녹색이 안 빠져서 브랜드색으로 새로 생성한
 * 방사형 버스트(warp_blue)로 갈았다. (한 축에 꿰인 네
